...
public class WrapperPlayServerBlockChange extends AbstractPacket {
    ...
    public boolean equals(WrapperPlayServerBlockChange packet) {
        return this.getBlockData().equals(packet.getBlockData()) &&
                this.getLocation().equals(packet.getLocation());
    }
}
