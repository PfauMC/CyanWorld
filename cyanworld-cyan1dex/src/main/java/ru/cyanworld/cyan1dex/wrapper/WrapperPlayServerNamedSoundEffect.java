...
public class WrapperPlayServerNamedSoundEffect extends AbstractPacket {
    ...
    /**
     * Сверяет два враппера
     *
     * @return true/false
     */
    public boolean equals(WrapperPlayServerNamedSoundEffect wrapper) {
        return this.getSoundEffect() == wrapper.getSoundEffect() &&
                this.getSoundCategory() == wrapper.getSoundCategory() &&
                this.getEffectPositionX() == wrapper.getEffectPositionX() &&
                this.getEffectPositionY() == wrapper.getEffectPositionY() &&
                this.getEffectPositionZ() == wrapper.getEffectPositionZ() &&
                this.getPitch() == wrapper.getPitch() &&
                this.getVolume() == wrapper.getVolume();
    }
}
