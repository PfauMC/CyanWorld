 ...
 */
package ru.cyanworld.cyan1dex.wrapper;
...
public class WrapperPlayServerWorldParticles extends AbstractPacket {
    ...
    public boolean equals(WrapperPlayServerWorldParticles packet) {
        return this.getParticleType() == packet.getParticleType() &&
                this.getLongDistance() == packet.getLongDistance() &&
                Arrays.equals(this.getData(), packet.getData()) &&
                this.getNumberOfParticles() == packet.getNumberOfParticles() &&
                this.getX() == packet.getX() &&
                this.getY() == packet.getY() &&
                this.getZ() == packet.getZ() &&
                this.getOffsetX() == packet.getOffsetX() &&
                this.getOffsetY() == packet.getOffsetY() &&
                this.getOffsetZ() == packet.getOffsetZ();
    }

    @Override
    public String toString() {
        return "WrapperPlayServerWorldParticles{" +
